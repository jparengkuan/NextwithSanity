...
export default defineCliConfig({
  ...
  deployment: {
    appId: 'to2q1uqhmyj9ru7bet3yhbqv',
    autoUpdates: true,
  },
  // Allow the Vite dev server to be reached through DDEV (https://website.ddev.site:3333)
  vite: (config) => ({
    ...config,
    server: {...config.server, allowedHosts: ['.ddev.site']},
  }),
  typegen: {
